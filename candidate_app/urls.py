...
from .views import user,mycandidates,Createcandidate,Detailcandidate,delete_candidate,Updatecandidate,Allcandidates,autocomplete_username,Filter,autocomplete_skills,all_filter,mycandidates_count,selected_candidates,rejected_candidates,inprogress_candidates,list_of_candidates,totalcandidates_count,saved_candidates,get_skills,selected_delete
from . import views
...
urlpatterns = [
    ...
    path('selected_delete/',selected_delete,name='selected_delete'),   
